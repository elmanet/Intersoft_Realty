    ...
    <div class="texto-inicial-anuncio"> 
      <div class="titulo-principal"> 
        ...
        if($preciov>0) {	  
         ...
         <?php 
        if($precioa>0) {    
          echo "<br>Alquiler: ".$row_config['simbolo_moneda']." ".number_format($precioa,2,'.',',');
         } ?>
      </h3>
  			<br>
	   		<a href="index.php?mg=anuncios-detalle&135798642Detalle=<?php echo $row_anuncio_gen['id_anuncio']; ?>" class="boton-anuncio">Ver Detalles</a>
	  </div>
  </div>
...
<?php 
 ...
 <?php }
    if($lastpage >$page ){?>       
      <li class="next"><a href="index.php?mg=anuncios&page=<?php echo $nextpage;?>" >Siguiente &raquo;</a></li>
      <?php 
    }else{?>
...
<?php  }
    ...
    ?>
       <li class="previous"><a href="index.php?mg=anuncios&page=<?php echo $prevpage;?>"  >&laquo; Anterior</a></li>
       <?php
...
<p style="font-size:19px; text-align:center;">"No Hay Anuncios Disponibles!"</p>            
</center>
<?php } ?>