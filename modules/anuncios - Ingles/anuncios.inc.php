...
<?php 
 ...
 <?php }
    if($lastpagecate >$pagecate ){?>       
      <li class="next"><a href="index.php?mg=categoria-de-productos&135798642=<?php echo $_GET['135798642'];?>&pagecate=<?php echo $nextpagecate;?>" >Next &raquo;</a></li>
      <?php 
    }else{?>
...
<?php  }
    ...
    ?>
       <li class="previous"><a href="index.php?mg=categoria-de-productos&135798642=<?php echo $_GET['135798642'];?>&pagecate=<?php echo $prevpagecate;?>"  >&laquo; Previous</a></li>
       <?php
...
<p style="font-size:19px; text-align:center;">"No records in this category"</p>            
</center>
<?php } ?>