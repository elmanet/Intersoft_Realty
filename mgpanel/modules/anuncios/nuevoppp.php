...
<div class="box-formulario2">
	...
	<tr>
		...
		<td colspan="2" align="center">
			...
			<a href="#" onclick="cargar('#divtest', 'modules/productos/admin.php')" class="btn btn-danger btn-lg"><i class="glyphicon glyphicon-remove"></i><span> Cancelar</span></a>	&nbsp;&nbsp;&nbsp;	 <input type="submit" id="grabar" class="btn btn-primary btn-lg " value="Grabar Nuevo" />
