...
$("#recarga").click(function(){
  $("#recargado").load('modules/anuncios/recargafoto-nuevo.php?id=<?php echo $_GET['id']; ?>');
}); 
			...
			<div ><a href="index.php?mod=gestor-anuncio" class="btn btn-danger btn"><i class="glyphicon glyphicon-arrow-right"></i><span> Finalizar</span></a>&nbsp;&nbsp;<a href="#" id="recarga" class="btn btn-primary btn"><i class="glyphicon glyphicon-repeat"></i><span> Recargar</span></a></div>
      ...
      <div ><a href="index.php?mod=gestor-anuncio" class="btn btn-danger btn"><i class="glyphicon glyphicon-arrow-right"></i><span> Continuar sin Cargar</span></a></div>
      <?php } ?>
