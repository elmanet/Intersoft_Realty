...
$(function(){
 ...
 $("#grabar").click(function(){
 	...
 	CKEDITOR.instances['des_catep'].updateElement();

 	if($("#nombre_catep").val().length < 3) {  
        $('#msgerror').show();
 ...
 var url = "modules/productos-categoria/grabando-padre.php"; // El script a dónde se realizará la petición.
    ...
    $.ajax({
         ...
         type: "POST",
           ...
           success: function(data) {
                ...
                setTimeout(function() {
              url = "index.php?mod=nueva-categoria-producto";
...
<div class="box box-warning">
     <div class="box-header">
            <h3 class="box-title">Agregar Nueva Categoría Padre</h3>
     </div><!-- /.box-header -->
<div class="box-body">
...
<table>
		<tr>	
			...
			<input class="form-control" type="text" id="nombre_catep" placeholder="Nombre de la Categoría Padre" name="nombre_catep" value="" style="width:300px;" />
			</div>
      		</td>
	 	</tr>
	 	...
	 	<tr>
			...
			<div class="input-group" id="coneditor">
			  <textarea  name="des_catep" id="des_catep" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>                      
             </div>
			</td>
		</tr>
		...
		<tr>
			...
			<a href="index.php?mod=nueva-categoria-producto"  class="btn btn-danger btn-lg"><i class="glyphicon glyphicon-remove"></i><span> Cancelar</span></a>	&nbsp;&nbsp;&nbsp;	 <input type="submit" id="grabar" class="btn btn-primary btn-lg " value="Grabar Nuevo" />
